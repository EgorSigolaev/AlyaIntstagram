...
class PostImageViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    fun bind(post: Post){
        ...
        textViewPostLikes.text = "${context.getString(R.string.like)}: ${(post.postType as Posts.PostImage).likes}"
        ...
        recyclerViewPost.adapter = PostImagesAdapter(urls = (post.postType as Posts.PostImage).imagesUrls, postType = post.postType!!)
